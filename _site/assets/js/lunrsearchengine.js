...
var documents = [{
    ...
    "id": 7,
    "url": "http://localhost:4000/tools-for-at-home-learning/",
    "title": "Tools for at home learning",
    "body": "2020/02/02 - Determine when student(s) will complete each task and stick to a schedule! Developing &amp; maintaining a summer routine is crucial to cultivating a conducive learning environment.  Summer Bridge Book.  Grade Specific Math curriculum book (GoMath etc. ) 2-3 Minute Math Drills for math facts Reading Level Appropriate List (“Just Right Books”) (can use websites like scholastic to determine reading level of a book)https://www. scholastic. com/teachers/bookwizard/ Specific Writing Prompts (based on book being read). Grades 2-3: 1 paragraph, Grades 3-5: 2-3 paragraphs Daily Journal (Students write about their daily routines &amp; activities the purpose of this task is to reinforce and strengthen writing skills, creative writing is not necessary for this task)These are a few to get stared. Go and have fun with it! "
    }, {
    "id": 8,
